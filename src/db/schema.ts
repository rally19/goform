...
export const forms = pgTable(
  "forms",
  {
    ...
    submissionLimitEnabled: boolean("submission_limit_enabled").notNull().default(false),
    submissionLimitRemaining: integer("submission_limit_remaining"),
    submissionLimitDecremental: boolean("submission_limit_decremental").notNull().default(false),
    ...
    previewBypass: boolean("preview_bypass").notNull().default(false),
